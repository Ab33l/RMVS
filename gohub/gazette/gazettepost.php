...
session_start();
// $newsId = $_SESSION['newsId'];        // Collecting data from query string
// if(!is_numeric($newsId)){ // Checking data it is a number or not
// echo "Data Error" . $_SESSION['newsId'];    
// exit;
// }

$newsId = $_GET['newsId'];
$query = $db->query("SELECT * FROM news WHERE newsId = $newsId");
if($query->num_rows > 0){ 
...
<body>
                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="breaking-news-area">
                            ...
                            <?php
                            //get rows query
                            $featuredquery = $db->query("SELECT * FROM news WHERE featured = '1' ORDER BY newsId DESC LIMIT 4");
                            if($featuredquery->num_rows > 0){ 
                                while($frow = $featuredquery->fetch_assoc()){
                                    $newsId = $frow['newsId'];
                            ?>
                            <li><a href="gazettepost.php?newsId=<?php echo $frow['newsId']; ?>"><?php echo $frow['newsTitle']; ?></a></li>
                            <?php } }else{ ?>
    ...
    <section class="single-post-area">
        ...
        ?>
        <!-- Single Post Title -->
        <div class="single-post-title bg-img background-overlay" style="background-image: url(<?php echo $row['newsImage']; ?>);">
            <div class="container h-100">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="single-post-thumb">
                            <img src="https://cloudfront-us-east-2.images.arcpublishing.com/reuters/7GABYOPC7JJT7PGIA75WGESXMQ.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-12 col-md-8">
                        <div class="single-post-text">
                ...
                <div class="col-12 col-md-8">
                    ...
                    <div class="leave-comment-area clearfix">
                        <div class="comment-form">
                            <div class="gazette-heading">
                                <h4 class="font-bold">To Get more Clarifications on the Product</h4>
                            </div>
                            <!-- Comment Form -->
                            <button type="submit" class="btn leave-comment-btn" onclick="window.open('http://localhost:3000/')">Join Our Chat<i class="fa fa-angle-right ml-2"></i></button>
