...
function fireSweetAlert() {
    ...
    text: 'RTGS Transaction Successfully Cleared from Your Queue'
})
}

</script>
<?php
    if($_SESSION["rtgs_success"] == false){
        ?>
        <script type="text/javascript">
        fireSweetAlert();
        </script>
        ...
        <div class="content">
            ...
            <div class="bg-secondary text-center rounded p-4">
                    ...
                    <?php
                            //get rows query
                            if($userType == 4){
                                $query = $db->query("SELECT * FROM instructions WHERE instructionStatus = '1' AND instructionItemId = '3'");
                            }else{
                                ...
                                if($first_query->num_rows > 0){
                                    ...
                                    $query = $db->query("SELECT * FROM instructions WHERE instructionStatus = '0' AND customerId IN ($newStr) AND instructionItemId = '3'");
                            }
                        }
                            if($query->num_rows > 0){ 
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-sm btn-primary txn-details" onclick="location.href='selectRtgs.php?instructionsId=<?php echo $row['instructionsId']; ?>'">Detail</button></td>
                                </tr>
                                <?php } }else{ ?>
                                <p>There are no pending RTGS Transactions in your queue</p>
                                <?php } ?>
                            </tbody>
                        </table>
                    </div>
