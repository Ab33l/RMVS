...
function fireSweetAlert() {
    ...
    text: 'TT Transaction Successfully Cleared from Your Queue'
})
}

</script>
    <?php
    if($_SESSION["tt_success"] == false){
        ?>
        <script type="text/javascript">
        fireSweetAlert();
        </script>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>TT</a>
                        <div class="dropdown-menu bg-transparent border-0">
        ...
        <div class="content">
            ...
            <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Telegraphic Transfer (TT) Transactions</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            //get rows query
                            if($userType == 4){
                                $query = $db->query("SELECT * FROM instructions WHERE instructionStatus = '1' AND instructionItemId = '4'");
                            }else{
                                ...
                                if($first_query->num_rows > 0){
                                    ...
                                    $query = $db->query("SELECT * FROM instructions WHERE instructionStatus = '0' AND customerId IN ($newStr) AND instructionItemId = '4'");
                            }
                        }
                            if($query->num_rows > 0){ 
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-sm btn-primary txn-details"  onclick="location.href='selectttTxn.php?instructionsId=<?php echo $row['instructionsId']; ?>'">Detail</button></td>
                                </tr>
                                <?php } }else{ ?>
                                <p>There are no pending TT Transactions in your queue</p>
                                <?php } ?>
                            </tbody>
                        </table>
                    </div>
