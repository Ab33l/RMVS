    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            if($query->num_rows > 0){ 
                ...
                if(($row['instructionItemId'] == '3')){
                ?>
                <button class="btn btn-primary" onclick="location.href='pendingrtgs.php'">Back</button>
                <?php }else{
                ?>
                <button class="btn btn-primary" onclick="location.href='pendingtt.php'">Back</button>
                <?php } }}?>
            </div>
            <hr>
