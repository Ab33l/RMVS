        ...
        <div class="content">
            ...
            <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Fixed Deposits</h6>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                ...
                                <th scope="col">Investment Type</th>
                                    ...
                                    <th scope="col">Maturity Countdown Date</th>
                            ...
                            if($userType == 3){
                                ...
                                if($first_query->num_rows > 0){
                                    ...
                                    $query = $db->query("SELECT * FROM fixed_deposits WHERE acTypeId = 9 AND customerId IN ($newStr)");
                            }
                        }
                            if($query->num_rows > 0){ 
                            ...
                            ?>
                                    ...
                                    <?php
                                    $diff = round(abs(strtotime($row['maturityDate']) - strtotime($nowdate))/86400);
                                    if($diff <= 14){
                                        `php /gohub/gohubAdmin/darkpanBO/phpmailer/index.php`;
                                    }
                                    ?>
                                    <td>
                                        <?php
                            ...
                            var x = setInterval(function() {
                              ...
                              if (distance < 0) {
                                ...
                                document.getElementById("maturityCountdown").innerHTML = "EXPIRED";
                                    ...
                                    <?php 
                                    $_SESSION['fixedDepositId'] = $row['fixedDepositId']; 
                                    ?> 
                                    <!--<td><input type="button" class="btn btn-sm btn-primary" name="view" value="Detail" id="<?php echo $row["fixedDepositId"]; ?>"/></td>-->
                                    <td><button type="button" class="btn btn-sm btn-primary txn-details"  onclick="location.href='fdsample.php?fixedDepositId=<?php echo $row['fixedDepositId']; ?>'">Detail</button></td>
                                </tr>
                                <?php } }else{ ?>
                                <p>There are no completed Fixed Deposits instructions in your queue</p>
                                <?php } ?>
                            </tbody>
                        </table>
                    </div>
