            ...
            <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            //get rows query
                            if($userType == 4){
                                $query = $db->query("SELECT * FROM instructions WHERE instructionStatus = '2' AND instructionItemId = '4'");
                            }else{
                                ...
                                if($first_query->num_rows > 0){
                                    ...
                                    $query = $db->query("SELECT * FROM instructions WHERE instructionStatus = '2' AND customerId IN ($newStr) AND instructionItemId = '4'");
                            }
                        }
                            if($query->num_rows > 0){ 
                            ...
                            ?>
                                ...
                                <?php } }else{ ?>
                                <p>There are no completed TT Transactions in your queue</p>
                                <?php } ?>
                            </tbody>
                        </table>
                    </div>
