...
function fireSweetAlert() {
    ...
    icon: 'success',
    title: 'Staff Status',
    text: 'Staff Status Successfully Updated'
})
}

</script>
<?php
    if($_SESSION["staffupdate_success"] == true){
        ?>
        <script type="text/javascript">
        fireSweetAlert();
        </script>
        ...
        $_SESSION["staffupdate_success"] = false;
    }
    ?>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Staff Email Address</th>
                            ...
                            //get rows query
                            if($userType == 4){
                                $query = $db->query("SELECT * FROM staff WHERE userType = '3'");
                            if($query->num_rows > 0){ 
                                while($row = $query->fetch_assoc()){
                            ?>
                            <tbody>
                                <tr>
                                    <td><?php echo $row['abNumber']; ?></td>
                                    <td>R.M</td>
                                    ...
                                    <?php 
                                    $_SESSION['rmId'] = $row['staffId']; 
                                    ?> 
                                    <!--<td><input type="button" class="btn btn-sm btn-primary" name="view" value="Detail" id="<?php echo $row["instructionId"]; ?>"/></td>-->
                                    <td><button type="button" class="btn btn-sm btn-primary txn-details"  onclick="location.href='selectstaff.php?rmId=$rmId'">Detail</button></td>
                                </tr>
                                <?php } }else{ ?>
                                <p>There are no RMs on the system</p>
                                <?php }} ?>
                            </tbody>
                        </table>
                    </div>
            ...
            <!-- Footer Start -->
            <div class="container-fluid pt-4 px-4" style="margin-top:310px;">
