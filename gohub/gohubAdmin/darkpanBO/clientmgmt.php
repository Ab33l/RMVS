...
<?php
    if($_SESSION["customerupdate_success"] == true){
        ?>
        <script type="text/javascript">
        fireSweetAlert();
        </script>
        ...
        $_SESSION["customerupdate_success"] = false;
    }
    ?>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Client Segment</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-sm btn-primary txn-details"  onclick="location.href='selectclient.php?sessionId=<?php echo $row['sessionId']; ?>'">Detail</button></td>
                                </tr>
                                <?php } }else{ ?>
                                <p>There are no clients on the system</p>
                                <?php }} ?>
                            </tbody>
                        </table>
                    </div>
            ...
            <!-- Footer Start -->
            <div class="container-fluid pt-4 px-4" style="margin-top:150px;">
