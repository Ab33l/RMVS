...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    header("location: /gohub/gohubAdmin/darkpanBO/pendingtt.php");
}
        ...
        <div class="content">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" autocomplete="off">
                        <div class="bg-secondary rounded h-100 p-4" style="width:70%;margin-left:15%;">
                            ...
                            <button class="btn btn-warning" style="margin-left:60%;" onclick="location.href='pendingtt.php'">Cancel</button>
                            </div>
                        </div>
                        <?php } }else{ ?>
